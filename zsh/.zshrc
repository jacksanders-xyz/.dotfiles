...
export PATH="/Applications/dsdriver/adm":"$PATH"

export DYLD_LIBRARY_PATH="/Applications/dsdriver/lib":"$DYLD_LIBRARY_PATH"

# Environment variables for sqlj and JDBC/JCC drivers
export CLASSPATH="/Applications/dsdriver/java/db2jcc4.jar":"$CLASSPATH"
export CLASSPATH="/Applications/dsdriver/java/sqlj4.zip":"$CLASSPATH"

# Environment variables for CLPPlus utility
export CLASSPATH="/Applications/dsdriver/tools/clpplus.jar":"$CLASSPATH"
export CLASSPATH="/Applications/dsdriver/tools/jline-0.9.93.jar":"$CLASSPATH"
export CLASSPATH="/Applications/dsdriver/tools/antlr-3.3-java.jar":"$CLASSPATH"
